...
class _PlaylistsViewState extends State<PlaylistsView>
      ...
      child: Column(
        children: [
          ...
          ListTile(
            ...
            title: const Text('اضافه کردن پلی لیست'),
          ),
  ...
  AlertDialog _buildDeletePlaylistDialog(
    ...
    return AlertDialog(
      ...
      content: Text('آیا میخواید پلی لیست "${playlist.playlist}"را حذف کنید؟'),
      actions: [
        TextButton(
          onPressed: () {
        ...
        TextButton(
          onPressed: () async {
            ...
            if (playlistName.isEmpty) {
              ...
              Fluttertoast.showToast(msg: 'اسم پلی لیست نباید خالی باشه');
              return;
            }
