        ...
        return Wrap(
          children: [
            ListTile(
              ...
              title: const Text('اضافه کردن به نوبت'),
              onTap: () {
            ...
            ListTile(
              leading: const Icon(Icons.playlist_add_outlined),
              title: const Text('اضافه کردن به پلی لیست'),
              onTap: () {
                Navigator.of(context).pop();
              },
            ),
            ListTile(
              ...
              title: const Text('پاک کردن آهنگ'),
              onTap: () {
                ...
                showDialog(
                  ...
                  builder: (BuildContext context) {
                    return AlertDialog(
                      title: const Text('پاک کردن آهنگ'),
                      content: const Text('آیا مطمعن هستید؟'),
                      actions: <Widget>[
                        TextButton(
                          onPressed: () {
                            Navigator.of(context).pop();
